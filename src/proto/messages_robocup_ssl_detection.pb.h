...
#ifndef messages_5frobocup_5fssl_5fdetection_2eproto_2epb_2eh
#define messages_5frobocup_5fssl_5fdetection_2eproto_2epb_2eh
...
/* @@protoc_insertion_point(class_definition:SSL_DetectionRobot) */ {
 public:
  ...
  void operator delete(SSL_DetectionRobot* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SSL_DetectionRobot* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:SSL_DetectionBall) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SSL_DetectionBall* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SSL_DetectionBall* New(::google::protobuf::Arena* arena = nullptr) const {
...
/* @@protoc_insertion_point(class_definition:SSL_DetectionFrame) */ {
 public:
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
  void operator delete(SSL_DetectionFrame* msg, std::destroying_delete_t) {
    SharedDtor(*msg);
  ...
  SSL_DetectionFrame* New(::google::protobuf::Arena* arena = nullptr) const {
 ...
 public:
  ...
  private:
  double _internal_t_capture_camera() const;
  void _internal_set_t_capture_camera(double value);
...
inline double SSL_DetectionFrame::t_capture_camera() const {
  ...
  return _internal_t_capture_camera();
}
inline void SSL_DetectionFrame::set_t_capture_camera(double value) {
  _internal_set_t_capture_camera(value);
  _impl_._has_bits_[0] |= 0x00000010u;
  // @@protoc_insertion_point(field_set:SSL_DetectionFrame.t_capture_camera)
}
inline double SSL_DetectionFrame::_internal_t_capture_camera() const {
  ::google::protobuf::internal::TSanRead(&_impl_);
  return _impl_.t_capture_camera_;
}
inline void SSL_DetectionFrame::_internal_set_t_capture_camera(double value) {
  ::google::protobuf::internal::TSanWrite(&_impl_);
  _impl_.t_capture_camera_ = value;
}
...
#endif  // messages_5frobocup_5fssl_5fdetection_2eproto_2epb_2eh
